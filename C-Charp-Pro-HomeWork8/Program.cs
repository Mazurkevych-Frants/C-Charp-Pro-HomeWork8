...
class Program
{
    static Semaphore customers = new Semaphore(0, 8); 
    ...
    static void Barber()
    {
        while (true)
        {
            ...
            Console.WriteLine("Происходит стрижка");
            Thread.Sleep(3000);
            Console.WriteLine("Стрижка закончена");
        }
    }
    ...
    static void Visitor(int id)
    {
        ...
        {
            Console.WriteLine($"Клиент ушёл, все места для ожидания заняты");
            mutex.Release();
        }
    }
